...
export interface CreateCompositeContestRequestTaskCreator { 
    holding_type: CreateCompositeContestRequestTaskCreator.HoldingTypeEnum;
    visibility: boolean;
}
export namespace CreateCompositeContestRequestTaskCreator {
