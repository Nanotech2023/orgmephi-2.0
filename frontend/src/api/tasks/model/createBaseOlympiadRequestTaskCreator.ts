...
export interface CreateBaseOlympiadRequestTaskCreator { 
    description: string;
    laureate_condition: number;
    name: string;
    olympiad_type_id: number;
    rules: string;
    subject: CreateBaseOlympiadRequestTaskCreator.SubjectEnum;
    target_classes: Array<CreateBaseOlympiadRequestTaskCreator.TargetClassesEnum>;
    winning_condition: number;
}
export namespace CreateBaseOlympiadRequestTaskCreator {
