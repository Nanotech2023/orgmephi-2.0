...
export class AddUserModalComponent implements OnInit
{
    ...
    @Output() newUserAdded: EventEmitter<TypeRegistrationPersonalInfo> = new EventEmitter<TypeRegistrationPersonalInfo>()
    ...
    register( registerUser: RequestRegistrationSchool ): void
    {
        ...
        this.newUserAdded.emit( registerUser.personal_info )
    }
