...
@module.route('/contest/<int:contest_id>/task/<int:task_id>/user/self/plain/file', methods=['POST'])
def self_user_answer_for_task_post_plain_file(contest_id, task_id):
    """
...
def self_user_answer_for_task_post_plain_file_old(contest_id, task_id, filetype):
    """
    Add current user answer for a task
    ---
    post:
      ...
      responses:
        ...
        '409':
          description: Timing error or file is too large
    """
    return self_user_answer_for_task_post_plain_file(contest_id, task_id)
